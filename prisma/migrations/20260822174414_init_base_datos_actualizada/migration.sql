...
-- CreateIndex
CREATE UNIQUE INDEX "asignaciones_docentes_id_docente_id_grado_seccion_id_materi_key" ON "asignaciones_docentes"("id_docente", "id_grado_seccion", "id_materia");
...
-- AddForeignKey
ALTER TABLE "grados_secciones" ADD CONSTRAINT "grados_secciones_id_docente_guia_fkey" FOREIGN KEY ("id_docente_guia") REFERENCES "personal"("id_personal") ON DELETE SET NULL ON UPDATE CASCADE;
