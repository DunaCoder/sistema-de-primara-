...
// ✅ Importación correcta según tu árbol de archivos
...
export async function crearUsuarioAction({ 
  ...
  try {
    ...
    await registrarAuditoria({
      ...
      modulo: 'USUARIOS',
      detalles: `Se creó el usuario '@${username}' (Rol: ${resultado.roles.nombre}). Resguardo: ${motivoResguardo || 'N/A'}`,
    });
    ...
    if (error.code === 'P2002') {
      return { success: false, error: "La cédula o nombre de usuario ingresado ya existe." };
    }
