...
export default function PeticionesPage() {
  ...
  const handleAprobar = (id) => {
    setSolicitudes((prev) =>
      prev.map((req) => (req.id === id ? { ...req, estado: "aprobado" } : req)),
    );
    // Aquí iría la llamada real al backend para crear el usuario
    console.log(
      `✅ Solicitud ${id} APROBADA. Usuario creado con rol correspondiente.`,
    );
  ...
  return (
    <div>
      ...
      <p className="text-gray-600 mb-4">
        Aquí puedes revisar las solicitudes de nuevos usuarios. Al aprobar, se
        creará automáticamente un usuario con el rol solicitado.
      </p>
