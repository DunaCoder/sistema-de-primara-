        ...
        <div className="px-6 pb-6 pt-0 relative">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between -mt-12 mb-6 gap-4">
            <div className="flex items-end gap-4">
              <div className="relative group">
                ...
                <button
                  onClick={() =>
                    alert("Función opcional: Subir foto de perfil")
                  }
            ...
            <div className="self-start sm:self-auto">
              <span
                className={`inline-block text-xs px-3 py-1 rounded-full font-bold border ${getRolBadge(perfil.rol)}`}
              >
                Rol: {perfil.rol}
              </span>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 border-t border-slate-100 pt-6">
            ...
            <div className="p-3 bg-slate-50 rounded-lg border border-slate-100">
              ...
              <span
                className={`text-sm font-semibold ${perfil.estado ? "text-emerald-600" : "text-rose-600"}`}
              >
